...
class UNREALTOURNAMENT_API UStatManager : public UObject
{
	 ...
	 *  @param VRPC The PC that uses this stat manager
	 */
	void InitializeManager(AVRPlayerState *VRPS);
	...
	*/
	...
	AVRPlayerState* GetPlayerState() { return VRPS; }

	virtual void PopulateJsonObjectForBackendStats(TSharedPtr<FJsonObject> JsonObject, AVRPlayerState* PS);
	...
	virtual void AddMatchToStats(const FString& MapName, const FString& GameType, const TArray<class AVRTeamInfo*>* Teams, const TArray<APlayerState*>* ActivePlayerStates, const TArray<APlayerState*>* InactivePlayerStates);
