...
#include "VRReplicatedEmitter.generated.h"
 ...
 * on dedicated servers, the effect will not play bVR the Actor should still be spawned and will stay alive long enough to send to current clients\
...
class UNREALTOURNAMENT_API AVRReplicatedEmitter : public AActor
{
