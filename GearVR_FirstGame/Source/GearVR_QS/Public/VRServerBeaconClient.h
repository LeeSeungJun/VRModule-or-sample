...
#include "VRServerBeaconClient.generated.h"
...
class AVRServerBeaconClient;

DECLARE_DELEGATE_TwoParams(FServerRequestResultsDelegate, AVRServerBeaconClient*, FServerBeaconInfo);
DECLARE_DELEGATE_OneParam(FServerRequestFailureDelegate, AVRServerBeaconClient*);
DECLARE_DELEGATE_ThreeParams(FServerRequestQuickplayDelegate, AVRServerBeaconClient*, const FName&, const FString&);
...
class UNREALTOURNAMENT_API AVRServerBeaconClient : public AOnlineBeaconClient
{
	GENERATED_UCLASS_BODY()

	// Begin AOnlineBeacon Interface
	//virtual FString GetBeaconType() override { return TEXT("VRServerBeacon"); }
