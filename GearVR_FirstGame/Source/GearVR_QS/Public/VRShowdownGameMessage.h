...
#include "VRShowdownGameMessage.generated.h"

UCLASS()
class UNREALTOURNAMENT_API UVRShowdownGameMessage : public UVRLocalMessage
{
	GENERATED_BODY()
public:
	UVRShowdownGameMessage(const FObjectInitializer& OI)
		: Super(OI)
	{
