...
void FLeapInputDevice::CallFunctionOnDelegates(TFunction< void(UObject*)> InFunction)
{
...
bool FLeapInputDevice::EmitKeyUpEventForKey(FKey Key, int32 User, bool Repeat)
{
	FKeyEvent KeyEvent(Key, FSlateApplication::Get().GetModifierKeys(), User, Repeat, 0, 0);
	return FSlateApplication::Get().ProcessKeyUpEvent(KeyEvent);
}

bool FLeapInputDevice::EmitKeyDownEventForKey(FKey Key, int32 User, bool Repeat)
{
	FKeyEvent KeyEvent(Key, FSlateApplication::Get().GetModifierKeys(), User, Repeat, 0, 0);
	return FSlateApplication::Get().ProcessKeyDownEvent(KeyEvent);
}

bool FLeapInputDevice::EmitAnalogInputEventForKey(FKey Key, float Value, int32 User, bool Repeat)
{
...
//Utility
bool FLeapInputDevice::HandClosed(float Strength)
{
	return (Strength == 1.f);
}

bool FLeapInputDevice::HandPinched(float Strength)
{
	return (Strength > 0.8);
}

bool FLeapInputDevice::HandForId(int32 CheckId, Leap::HandList Hands, Leap::Hand& ReturnHand)
{
...
FLeapInputDevice::FLeapInputDevice(const TSharedRef< FGenericApplicationMessageHandler >& InMessageHandler) : MessageHandler(InMessageHandler) 
{
...
void FLeapInputDevice::ParseEvents()
{
...
void FLeapInputDevice::SetMessageHandler(const TSharedRef< FGenericApplicationMessageHandler >& InMessageHandler)
{
...
void FLeapInputDevice::SetChannelValue(int32 ControllerId, FForceFeedbackChannelType ChannelType, float Value)
{
	// Nothing necessary to do (boilerplate code to complete the interface)
}
...
void FLeapInputDevice::ClearReferences(UObject* object)
{
	if (object != nullptr)
	{
...
void FLeapInputDevice::AddEventDelegate(UObject* EventDelegate)
{
...
void FLeapInputDevice::RemoveEventDelegate(UObject* EventDelegate)
{
